      ...
      <div className="flex-1 flex items-center justify-center bg-white px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center"><span className="bg-white px-4 text-sm text-gray-400">Or login with</span></div>
          </div>
          ...
          <div className="bg-white/20 rounded-xl p-5 text-left">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-white/80">
                ...
                <span>Mohit Singh replied to your post</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-white/80">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span>3 new connection requests</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-white/80">
                <div className="w-2 h-2 bg-yellow-300 rounded-full"></div>
                <span>Webinar in 2 days: AI in India</span>
              </div>
            </div>
          </div>
        </div>
